...
const Footer = () => {
  ...
  const footerLinks = [
    ...
    },
    {
      title: 'Products',
      links: [
        { name: 'PulseCheck', href: '#' },
        { name: 'MyMoneyMedic', href: '#' },
        { name: 'Partners Area', href: '#' },
        { name: 'API', href: '#' },
      ],
    },
  ];
  ...
  const getSocialIconPath = (icon: string): string => {
    switch (icon) {
      case 'twitter':
  ...
  return (
    <footer className="bg-dark-800 text-dark-100">
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Brand Section */}
          <div className="col-span-1">
            <h3 className="text-2xl font-bold text-primary-500 mb-4">MyMoneyMedic</h3>
            <p className="text-dark-300 mb-6">
              Empowering your financial wellness journey with AI-powered insights.
            </p>
              ...
              {socialLinks.map((social) => (
                ...
                >
                  ...
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                    <path d={getSocialIconPath(social.icon)} />
                  </svg>
                </button>
              ))}
            </div>
        ...
        {/* Copyright */}
        <div className="border-t border-dark-700 mt-12 pt-8 text-center text-dark-300">
